...
----+------------+-----------+----+--------+---------+------+---------+----------
  ...
  7 | Maya       | Malarkin  |    |        |         |      |         |
(15 rows)*/
*/Answer*/SELECT * FROM owners JOIN vehicles ON owners.id = vehicles.owner_id;
...
(6 rows)
*/
*/Answer*/SELECT first_name, last_name, COUNT(*) FROM owners JOIN vehicles ON owners.id = vehicles.owner_id GROUP BY first_name, last_name, owner_id ORDER BY count ASC;
